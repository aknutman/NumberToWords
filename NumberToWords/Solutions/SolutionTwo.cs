...
namespace NumberToWords.Solutions
{
    ...
    {
        /*
         * This class is not used. And being created for demonstration purposed only
         * It serve the posssibility of doing multiple algorithm or sollution, without modifying the existing class
